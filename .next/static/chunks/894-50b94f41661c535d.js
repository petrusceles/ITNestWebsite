...
`,pe=t=>{const{cascade:e=!1,damping:n=.5,delay:o=0,duration:a=1e3,fraction:i=0,keyframes:s=re,triggerOnce:c=!1,css:l,className:u,style:f,childClassName:d,childStyle:p,children:m,onVisibilityChange:y}=t,h=(0,r.useMemo)((()=>function({duration:t=1e3,delay:e=0,timingFunction:n="ease",keyframes:r=re,iterationCount:o=1}){return It`
  ...
  `}({keyframes:s,duration:a})),[a,s]);return void 0==m?null:"string"===typeof(g=m)||"number"===typeof g||"boolean"===typeof g?Zt(me,{...t,animationStyles:h,children:String(m)}):(0,qt.isFragment)(m)?Zt(ye,{...t,animationStyles:h}):Zt(Qt,{children:r.Children.map(m,((s,m)=>{if(!(0,r.isValidElement)(s))return null;const g=[l,h],v=o+(e?m*a*n:0);switch(s.type){case"ol":case"ul":return Zt(Rt,{children:({cx:e})=>Zt(s.type,{...s.props,className:e(u,s.props.className),style:{...f,...s.props.style},children:Zt(pe,{...t,children:s.props.children})})});case"li":return Zt(Xt,{threshold:i,triggerOnce:c,onChange:y,children:({inView:t,ref:e})=>Zt(Rt,{children:({cx:n})=>Zt(s.type,{...s.props,ref:e,className:n(d,s.props.className),css:t?g:fe,style:{...p,...s.props.style,animationDelay:v+"ms"}})})});default:return Zt(Xt,{threshold:i,triggerOnce:c,onChange:y,children:({inView:t,ref:e})=>Zt("div",{ref:e,className:u,css:t?g:fe,style:{...f,animationDelay:v+"ms"},children:Zt(Rt,{children:({cx:t})=>Zt(s.type,{...s.props,className:t(d,s.props.className),style:{...p,...s.props.style}})})})})}}))});var g},me=t=>{const{animationStyles:e,cascade:n=!1,damping:r=.5,delay:o=0,duration:a=1e3,fraction:i=0,triggerOnce:s=!1,css:c,className:l,style:u,children:f,onVisibilityChange:d}=t,{ref:p,inView:m}=Ut({triggerOnce:s,threshold:i,onChange:d});return n?Zt("div",{ref:p,className:l,css:[c,de],style:u,children:f.split("").map(((t,n)=>Zt("span",{css:m?e:fe,style:{animationDelay:o+n*a*r+"ms"},children:t},n)))}):Zt(ye,{...t,children:f})},ye=t=>{const{animationStyles:e,fraction:n=0,triggerOnce:r=!1,css:o,className:a,style:i,children:s,onVisibilityChange:c}=t,{ref:l,inView:u}=Ut({triggerOnce:r,threshold:n,onChange:c});return Zt("div",{ref:l,className:a,css:u?[o,e]:fe,style:i,children:s})};jt`
  from,
  20%,
  40%,
  60%,
...
`;var Pe=t=>{const{big:e=!1,direction:n,reverse:o=!1,...a}=t,i=(0,r.useMemo)((()=>function(t,e,n){switch(n){case"bottom-left":return e?ge:Jt;case"bottom-right":return e?ve:te;case"down":return t?e?we:ne:e?be:ee;case"left":return t?e?xe:oe:e?Ce:re;case"right":return t?e?Ee:ie:e?Oe:ae;case"top-left":return e?Se:se;case"top-right":return e?_e:ce;case"up":return t?e?ke:ue:e?Te:le;default:return e?he:Kt}}(e,o,n)),[e,n,o]);return Zt(pe,{keyframes:i,...a})};jt`
  from {
...
`;var He=t=>{const{direction:e,reverse:n=!1,...o}=t,a=(0,r.useMemo)((()=>function(t,e){switch(e){case"down":return t?Le:Me;case"right":return t?Re:je;case"up":return t?Ne:Ae;default:return t?ze:Ie}}(n,e)),[e,n]);return Zt(pe,{keyframes:a,...o})};jt`
  from {
    opacity: 0;
    transform: scale3d(0.3, 0.3, 0.3);
  }
